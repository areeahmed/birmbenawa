...
import 'package:birmbenawa/src/screens/LandScreen/collection_of_navigatbar_and_drawer.dart';
      ...
      body: StreamBuilder(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              Get.snackbar('کێشە هەیە', 'کێشە لە بەرنامەکە هەیە!');
  ...
  Widget SignInButtonWidget() {
    return Container(
      ...
      child: GeneralCustomButtonWidget(
        ...
        ontap: () {
          setState(() {
            //TODO hunddle the missing value here
            if (firstNumnberController.text == '' ||
              ...
              Get.snackbar('نرخ', 'هەندێک لە نرخەکان نادیارە');
            } else {
              ...
              authClass.sendVerificationCode(context, verificationId,
                  smsCodeControllerCollectionInString!);
            }
          });
        },
