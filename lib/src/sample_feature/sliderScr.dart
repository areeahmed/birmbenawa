...
class LandScreenSlides extends StatelessWidget {
  const LandScreenSlides({Key? key,
  }) : super(key: key);
  ...
  Widget buildImage (String path) => Center( 
    child: Image.asset(path), widthFactor: 350,);
  // TODO: this is a methode for Returning the decoration of title of the slider page
  PageDecoration getPageDecoration() => const PageDecoration( 
        titleTextStyle: TextStyle( fontSize: 28, fontWeight: FontWeight.bold, fontFamily: 'KurdBold'),
